...
export const metadata = {
  title: 'Document Assistant - Chat with Your Files',
  description: 'AI-powered document assistant using RAG with Supabase',
  icons: {
    icon: '/icon.svg',
  },
};
      ...
      <body className="h-full">
        <Providers>
          <div className="flex flex-col items-center h-full">
            ...
            <footer className="w-full py-4 text-center text-sm text-gray-500 border-t border-gray-100">
              Developed by{' '}
              <a
